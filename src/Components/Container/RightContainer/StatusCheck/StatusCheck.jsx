...
function StatusCheck() {
  ...
  useEffect(() => {
    document.getElementById('copyIcon6').onclick = () => {
      navigator.clipboard.writeText('https://{base_url} /transaction/013/status?user=apiuser&password=apiuserpassword&sid=900000&mdorder=eed077dc-cad0-4ed5-8a15-608ffc592173');
  ...
  return (
    <div id='status' className='statusCheck' >
      ...
      <p className="componentParagraph">
        ...
        <span className="text-url">{'{base_url}/transaction/{code}/status'}</span>
        <br />
        <br />
        <span className="text-bold">{'Request example: '}</span> <br />
        <span className="text-url">{'https://{base_url}/transaction/013/status?user=apiuser&password=apiuserpassword&sid=900000&mdorder=eed077dc-cad0-4ed5-8a15-608ffc592173'}</span>
      ...
      <p className="componentParagraph">
        ...
        <span className="iframe">
          <span className="text-url">{'{"Description": "Request processed successfully",'}</span>
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"Amount": 50.0,
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"Fee": 1.0,
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"OrderId": "eed077dc-cad0-4ed5-8a15-608ffc592173",
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"Code": "0",
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"Timestamp": "2022-10-28 10:23:54.133177",
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"Success": true,
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"RRN": "000011341431",
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"Auth": "524269",
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"Currency": 978,
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"Pan": "500000**0000",
          <br />&nbsp;&nbsp;&nbsp;&nbsp;"order_status": "2",
          <br /><span className="text-url">{'"status": "DEPOSITED"}'}</span>
        </span>
        <br /><br />
